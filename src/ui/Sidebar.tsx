    ...
    <>
      ...
      {!isOpen && !isDesktop && (
        <button
          ...
          className="fixed top-20 left-4 z-50 flex items-center gap-2 px-4 py-2 bg-white border border-gray-300 shadow-md rounded-full text-gray-800 hover:bg-blue-50 hover:border-blue-400 transition-colors"
